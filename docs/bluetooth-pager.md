...
Jeder GATT-Read liefert einen vollständigen Feed (maximal 512 Byte entsprechend dem GATT-Characteristic-Limit); Fragmentierung über mehrere Notifications wird nicht verwendet. Der Sender muss längere Reads gegebenenfalls über GATT Read Blob unterstützen. Die App liest beim Koppeln, bei manueller Aktualisierung und alle 60 Sekunden im sichtbaren Tab. Inhalte werden vor der Anzeige validiert und als Text gerendert. Abgelaufene Nachrichten werden ausgeblendet.
